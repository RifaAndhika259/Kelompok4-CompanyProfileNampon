...
<head>
  ...
  <title>Login</title>
  <!--favicon-->
  <link rel="icon" href="{{URL::to('image/nampon.jpg')}}" type="image/x-icon">
  <!-- Bootstrap core CSS-->
            ...
            {{csrf_field()}}
			  <div class="form-group">
			   <div class="position-relative has-icon-right">
				  ...
				  <input name="email" type="text" id="exampleInputEmail" class="form-control form-control-rounded" placeholder="Email">
